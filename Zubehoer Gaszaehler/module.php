...
class EseraGaszaehler extends IPSModule {
    public function Create(){
        ...
        $this->RegisterPropertyInteger("LimitValue", 1000);
        ...
        $this->RegisterVariableFloat("LeistungTag", "Leistung Tag", "~Gas", 4);
        $this->RegisterVariableFloat("LeistungVortag", "Leistung Vortag", "~Gas", 5);
        $this->RegisterVariableInteger("MonatCounter", "Counter Monat", "", 6);
        $this->RegisterVariableFloat("LeistungMonat", "Leistung Monat", "~Gas", 7);
        $this->RegisterVariableFloat("LeistungVormonat", "Leistung Vormonat", "~Gas", 8);
        $this->RegisterVariableInteger("JahrCounter", "Counter Jahr", "", 9);
        $this->RegisterVariableFloat("LeistungJahr", "Leistung Jahr", "~Gas", 10);
        $this->RegisterVariableFloat("LeistungVorjahr", "Leistung Vorjahr", "~Gas", 11);
        $this->RegisterVariableFloat("MaxLeistung", "Maximal Tag", "~Gas", 12);
        $this->RegisterVariableInteger("MaxLeistungZeit", "Maximal Tag Zeit", "~UnixTimestamp", 13);
        $this->RegisterVariableBoolean("Limit Value Year", "Jahreslimit", "", 14);
